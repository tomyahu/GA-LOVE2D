...
-- class: D545_2_FitnessFun
local D545_2_FitnessFun = extend(FitnessFun, function(self)
...
function D545_2_FitnessFun.initAux(self)
...
function D545_2_FitnessFun.mainFun(self)
    local dash_attack_points = self.dash_attacks / 8
    local special_dash_points = self.triggered_special_dash + self.landed_special_dash*10*(1 + (self.landed_special_dash - self.special_dash_shout) * 9)
...
function D545_2_FitnessFun.stepFun(self)
