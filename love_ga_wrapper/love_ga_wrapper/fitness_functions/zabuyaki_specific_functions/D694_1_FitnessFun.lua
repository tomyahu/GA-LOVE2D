...
-- class: D694_1_FitnessFun
local D694_1_FitnessFun = extend(FitnessFun, function(self)
    self.rick_combo_1_array = {}
    self.rick_combo_2_array = {}
    self.rick_dash_attack_array = {}
    self.rick_dash_attack_hitboxes_array = {}

    self.dash_attack_hitbox_num = 6
...
function D694_1_FitnessFun.initAux(self)
    self.rick_combo_1_array = {}
    self.rick_combo_2_array = {}
    self.rick_dash_attack_array = {}
    self.rick_dash_attack_hitboxes_array = {}
    ...
    fitness_var_rick_combo_1 = false
    fitness_var_rick_combo_2 = false
    fitness_var_rick_dash_attack = false
    fitness_var_rick_dash_attack_hitboxes = false
...
function D694_1_FitnessFun.mainFun(self)
    ...
    local last_move_delta_frames = 16

    local last_last_move = -1
    local last_move = -1
    local frames_since_last_combo = 0
    for i = 1, (# self.rick_combo_1_array) do
        local current_move = -1
        if self.rick_combo_1_array[i] then current_move = 0 end
        if self.rick_combo_2_array[i] then current_move = 1 end
        if self.rick_dash_attack_array[i] then current_move = 2 end
...
function D694_1_FitnessFun.stepFun(self)
    table.insert(self.rick_combo_1_array, fitness_var_rick_combo_1)
    fitness_var_rick_combo_1 = false

    table.insert(self.rick_combo_2_array, fitness_var_rick_combo_2)
    fitness_var_rick_combo_2 = false

    table.insert(self.rick_dash_attack_array, fitness_var_rick_dash_attack)
    fitness_var_rick_dash_attack = false

    table.insert(self.rick_dash_attack_hitboxes_array, fitness_var_rick_dash_attack_hitboxes)
    fitness_var_rick_dash_attack_hitboxes = false
